...
def main():
    ...
    name_list = os.listdir(path_stock_pool)
    name_list.sort()
    stock_pool_list = [f for f in name_list if
    ...
    # path_output = '/Users/fatjimmy/Desktop/Quant/generated_factor/technical_analysis/piece/lg(a)+lg(b)_process/'
    path_factor = '/Users/fatjimmy/Desktop/Quant/generated_factor/technical_analysis/original/lg(a)+lg(b)/rel_ipo_pct_chg & con_na_yoy/'
    path_output = '/Users/fatjimmy/Desktop/rel_ipo_pct_chg & con_na_yoy/'
    ...
    #for index in range(0,5):
        if os.path.exists(path_factor + onlyfiles[index]):
            ...
            factor = factor.reindex(
                columns=['stock_code', 'industry', 'factor_value', 'close', 'close_next', 'amt', 'return_ratio', 'ev', 'turn'])
