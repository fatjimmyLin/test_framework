...
def CalculateICIR_byYear(path_factor, market_index, isFlu, a, b, path_result):

    txt_path = path_result + a + ' & ' + b + '.txt'
    curve_path = path_result + a + ' & ' + b  + '.png'
    ...
    print('IC_years:=', ic_mean_years)
    # print('IC_IR_years:=', ir_years)
    # print('\n')
    if(abs(ic_mean_years) >= 0.18):
...
# change
    path_result = '/Users/fatjimmy/Desktop/Quant/generated_factor/technical_analysis/result/lg(a%b)+lg(b%a)/'
...
# change
            path_factor = '/Users/fatjimmy/Desktop/Quant/generated_factor/technical_analysis/after_preprocess/' \
            ...
            CalculateICIR_byYear(path_factor, market_index, isFlu, column_list[i], column_list[j], path_result)
