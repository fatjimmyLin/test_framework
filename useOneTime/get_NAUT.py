...
def main():
    ...
    path_output = '/Users/fatjimmy/Desktop/CMB_REPORT_RESEARCH_process/'
    ...
    df_dict.to_csv('/Users/fatjimmy/Desktop/NAUT.csv', encoding='gbk', index=False)
    df_researchers = pd.DataFrame(
        {'USER_NAME':researchers,
         'ORG_ID': organization,
         })
    print(df_researchers)
    df_researchers.to_csv('/Users/fatjimmy/Desktop/researchers.csv', encoding='gbk', index=False)
